    ...
    <nav className="bg-blue-400 p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          ...
          {user && (
            <Link to={`/worker/profile/${user._id}`} className="text-white" onClick={closeMenu}>Profile</Link>
          )}
          <Link to="/worker-appointments" className="text-white" onClick={closeMenu}>Appointments</Link>
          {token ? (
            <>
              <DropdownMenu />
            </>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-blue-400">
          ...
          <Link to="/worker/profile" className="block py-2 px-4 text-white" onClick={closeMenu}>profile</Link>
          <Link to="/worker-appointments" className="block py-2 px-4 text-white" onClick={closeMenu}>Appointments</Link>
          {user ? (
            <>
              <DropdownMenu />
            </>
